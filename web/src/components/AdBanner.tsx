...
export function AdBanner(){
    return (
        <div className='pt-1 bg-nlw-gradient rounded-lg overflow-hidden mt-8 sm:w-[85%] lg:self-stretch'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between sm:grid sm:grid-cols-1'>
          <div >
